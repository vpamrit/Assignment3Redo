...
slice_size = 240
dset_train = SpleenDatasetBuilder(DATA_FOLDER, (0, 0)).dataset
dset_valid = SpleenDatasetBuilder(DATA_FOLDER, (1, 1)).dataset
...
def train(epoch, counter):
    ...
    valid_loader = DataLoader(dset_valid, batch_size=1)
    model.eval()
